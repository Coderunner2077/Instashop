    ...
    return (
        <div className="hero-banner-container">
            <div>
                ...
                <img src={urlFor(bannerData.image)} alt="headphones" className="absolute pointer-events-none lg:-top-20 md:top-0 top-1/4 lg:right-[2%] md:right-0 right-[5%] lg:w-[600px] lg:h-auto md:h-96 md:w-96 w-64 h-64" />
