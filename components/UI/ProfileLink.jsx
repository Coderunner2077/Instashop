...
const ProfileLink = ({ src, icon, text, onClick, position = "", onClicked }) => {
    return (
        <li className="w-full mx-0">
            {src ? (
                <Link href={src}>
                    <div className={`relative flex gap-1 link py-2 px-4 hover:bg-gray-100 cursor-pointer`} onClick={onClicked}>
